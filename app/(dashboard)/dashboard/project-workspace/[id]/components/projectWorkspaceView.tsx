...
export default function ProjectWorkspaceView() {
  ...
  //     if (project.hasMilestones && project.milestones) {
  //       setExtendedMilestoneDeadlines(
  //         project.milestones.map((m) => ({ id: m.id, deadline: m.deadline })),
  //       );
  //     } else {
  //       setExtendedMilestoneDeadlines([]);
  //     }
  ...
  //   if (project.agreementStatus !== "accepted") return 0; // Pending invite
