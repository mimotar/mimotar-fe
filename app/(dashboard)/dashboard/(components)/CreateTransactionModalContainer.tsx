...
export default function CreateTransactionModalContainer({
  ...
  return (
    ...
    >
      <section
        className={`flex flex-col ${className} md:w-[730px]  w-11/12 h-11/12 bg-white rounded-md shadow-md sm:p-6 p-4`}
      >
        <div className="flex flex-col space-y-3 mb-10">
          ...
          {/* display on mobile  */}
          <div className="flex min-[700px]:hidden justify-between px-2">
            {/* {getCreateTransactionModalStage.stage == 1 ? ( */}
            <p className="font-medium text-neutral-900 min-[425px]:text-base text-xs">
              Step 1 of 3
            </p>
            {/* ) : getCreateTransactionModalStage.stage == 2 ? ( */}
            <p className="font-medium text-neutral-900 min-[425px]:text-base text-xs">
