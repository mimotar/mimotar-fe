interface HelpOutlineIconProps extends React.HTMLAttributes<HTMLOrSVGElement> {
  className?: string;
}
const HelpOutlineIcon = ({ className, ...props }: HelpOutlineIconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#clip0_1896_7031)">
      <path
