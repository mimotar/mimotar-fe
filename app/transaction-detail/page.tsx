  ...
  return (
    <main className='px-5 lg:px-10 2xl:px-16 py-3 grid gap-14'>
      <section className='flex flex-col-reverse md:flex-row w-full justify-between gap-3  md:items-center'>
        <h3 className='text-black font-semibold text-2xl'>Transaction Detail & Agreement</h3>
        ...
        <div className='w-full md:w-4/6 gap-14 grid '>
          <div className=" grid ">
            <div className='bg-[#F8FAFC] w-full px-6 rounded-tr-lg rounded-tl-lg py-4'>
              <h4 className='text-black leading-5 text-xl'> Transaction details</h4>
            </div>
            <div className="bg-[#F1F5F9] w-full rounded-bl-lg rounded-br-lg px-6 py-4 grid gap-8">
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> First transactor</h5>
                  <p className='text-[#0F172A] font-semibold'> Salisu Isa </p>
                  <p className='text-[#0F172A] font-normal'> salisuisa@gmail.com </p>
                  <p className='text-[#0F172A] font-normal'> +234 806 566 5461</p>
                </div>
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> Second transactor</h5>
                  <p className='text-[#0F172A] font-semibold'> Olawale Ade </p>
                  <p className='text-[#0F172A] font-normal'> olawale02@gmail.com</p>
                  <p className='text-[#0F172A] font-normal'> +234 806 566 5461</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> Transaction description</h5>
                  <p className='text-[#0F172A] font-normal'>
                    Purchase of a HP Elitebook 820 UK-used laptop
                  </p>
                </div>
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> Amount</h5>
                  <p className='text-[#0F172A] font-normal'> NGN 340,000 </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> Transaction ID</h5>
                  <p className='text-[#0F172A] font-normal'>
                    60024321
                  </p>
                </div>
                <div className="flex flex-col justify-start gap-1">
                  <h5 className='text-[#64748B] font-semibold text-lg'> Date</h5>
          ...
          <div className=" grid">
            <div className='bg-[#F8FAFC] w-full px-6 rounded-tr-lg rounded-tl-lg py-4'>
              <h4 className='text-black leading-5 text-xl'> Transaction agreement</h4>
            </div>
            <div className="bg-[#F1F5F9] w-full rounded-bl-lg rounded-br-lg px-6 py-4 grid gap-8">
              <div className="">
                <span className='flex items-center gap-1'>
                  Who will pay the escrow fee?
                  <button title='Here is the information' className=''> <Info /> </button>
                </span>
              ...
              <div className="">
                ...
                <p className=' font-semibold'>During the inspection or testing period, buyer should test the laptop carefully as I wont accept it back if there is any dent or external issues.</p>
              </div>
            </div>
          </div>
        </div>
